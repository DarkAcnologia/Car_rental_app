...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  await Supabase.instance.client.from('profiles').upsert({
    ...
    'email': user!.email,
    'is_verified': false, // сброс подтверждения
  });
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              Text('Почта: ${email ?? user!.email}', style: const TextStyle(color: Colors.black)),
                          ...
                          ClipRRect(
                            ...
                            child: AspectRatio(
                              ...
                              child: Image.network(
                                faceUrl!,
                                fit: BoxFit.cover,
                                errorBuilder: (_, __, ___) => const Text('Ошибка загрузки'),
                              ),
                            ),
                          ),
